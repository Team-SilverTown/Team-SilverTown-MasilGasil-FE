...
const DUMMY_DATA: MatePost = {
  ...
  content: `길게길게 써야할것 같은데 뭐라고 써야할지 모르겠어요! 일단 이건 더미 데이터니까 아무말이나 미친듯이 쓰고 있는데 혹시 저희 글자 제한이 존재할까요? 근데 content니까 글자 제한을 두는것도 좀 그럴려나요? 그리고 이걸 엄청 길게 쓰는 사람이 있을까요? 태그도 만들어야할까요? 고민할게 많네요?? 근데 방학이 방학같지 않네요.. 할것도 없고 후... 우리팀이 압도적으로 UI가 이쁠수도 있을것같아요 근데 이러고 최종 발표회때 우와.. 하면서 다른 팀걸 지켜보고있겠죠? 이정도로 길게쓰면 될까요?`,

  // 일단 임시로 스트링으로 직접 날짜 표시 -  추후 변환 함수 생성 예장
  mateTime: "2024-3-10 오후 3:40",
